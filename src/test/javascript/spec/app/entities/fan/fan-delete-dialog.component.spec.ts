...
import { FanDeleteDialogComponent } from 'app/entities/fan/fan-delete-dialog.component';
import { FanService } from 'app/entities/fan/fan.service';

describe('Component Tests', () => {
  describe('Fan Management Delete Component', () => {
    let comp: FanDeleteDialogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FanDeleteDialogComponent, '')
        .compileComponents();
