...
describe('Service Tests', () => {
  describe('Spot Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(SpotService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Spot('ID', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Spot', () => {
        ...
        service.create(new Spot()).subscribe(resp => (expectedResult = resp.body));
